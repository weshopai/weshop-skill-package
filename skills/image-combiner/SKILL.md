...
- Apply the shared `model-selection-policy.md`. Prefer GPT Image 2 Medium when product, person, logo, or subject consistency is central; it is also mandatory for readable typography.
