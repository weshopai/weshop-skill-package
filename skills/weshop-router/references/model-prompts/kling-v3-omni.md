...
- Current WeShop Agent is `kling-v3-omni` with `modelName: Kling_V3_Omni`, 0–4 images, up to one video, 3–15 seconds, `16:9|9:16|1:1`, and optional `generateAudio`. MiniMax-only 4K, placeholder, and variant rules are not WeShop fields.
