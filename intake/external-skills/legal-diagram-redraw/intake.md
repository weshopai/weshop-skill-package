# External Skill intake: legal-diagram-redraw
...
- User-visible outcomes: editable redraw of a supplied legal diagram.
...
- Proposed standalone Atom: legal-diagram-redraw
...
- Proposed frontmatter distinction: Use for editable redraw of a supplied legal diagram; unlike $make-infographic (relationship 0.67), select it for its declared output contract.
...
| --- | --- | --- |
| Create a editable redraw of a supplied legal diagram | legal-diagram-redraw | Candidate output is explicit |
| Plan a editable redraw of a supplied legal diagram with preserved facts | legal-diagram-redraw | Candidate contract applies |
| Revise this editable redraw of a supplied legal diagram without changing approved assets | legal-diagram-redraw | Candidate preservation applies |
