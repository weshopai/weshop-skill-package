---
name: testimonial-quote-video
description: Use for attributed animated testimonial-video plan from approved user facts and assets; unlike $make-video-intro (relationship 0.67), choose this when the stated specialized output and preservation contract are required; choose $make-video-intro for its generic final-media contract.
---
...
- Tone: blue
- Short description: Attributed animated testimonial-video plan.

## What this skill does

- Freezes the request, approved facts, source assets, constraints, and acceptance checks.
- Produces one structured brief for: attributed animated testimonial-video plan.
...
```text
Create a attributed animated testimonial-video plan from my approved source material. Preserve the named facts and clearly identify every assumption.
```
