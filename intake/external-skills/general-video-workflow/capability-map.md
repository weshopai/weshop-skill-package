# WeShop capability substitution: general-video-workflow

| External behavior | Inputs and constraints | WeShop decision | Evidence |
| --- | --- | --- | --- |
| A general multi-stage video topology, represented by the Router DAG and selected outcome Atoms. | Authorized assets/facts, explicit preservation constraints, and observable acceptance | Compose/differentiate; use only a current verified route if promoted | Source entrypoint review and current Router contract |
