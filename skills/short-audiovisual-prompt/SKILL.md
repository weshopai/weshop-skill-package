---
name: short-audiovisual-prompt
description: Use for compact single-shot audiovisual video prompt from approved user facts and assets; unlike $generate-video (relationship 0.67), choose this when the stated specialized output and preservation contract are required; choose $generate-video for its generic final-media contract.
---
# Short Audiovisual Prompt
...
- Produces one structured brief for: compact single-shot audiovisual video prompt.
...
```text
Create a compact single-shot audiovisual video prompt from my approved source material. Preserve the named facts and clearly identify every assumption.
```
