...
- Apply the shared `model-selection-policy.md`. Any readable title, copy, Chinese, or multilingual content routes to GPT Image 2 Medium; do not fall back across models for text accuracy.
