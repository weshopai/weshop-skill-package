---
name: handdrawn-story-video
description: Use for silent hand-drawn story-video plan and render brief from approved user facts and assets; unlike $make-podcast-video (relationship 0.67), choose this when the stated specialized output and preservation contract are required; choose $make-podcast-video for its generic final-media contract.
---
# Hand-drawn Story Video
...
- Tone: blue
- Short description: Silent hand-drawn story-video plan and render brief.

## What this skill does

- Freezes the request, approved facts, source assets, constraints, and acceptance checks.
- Produces one structured brief for: silent hand-drawn story-video plan and render brief.
...
```text
Create a silent hand-drawn story-video plan and render brief from my approved source material. Preserve the named facts and clearly identify every assumption.
```
...
- Downstream use: $make-podcast-video or another verified Atom selected by Router intent matching
