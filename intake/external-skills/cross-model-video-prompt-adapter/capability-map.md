# WeShop capability substitution: cross-model-video-prompt-adapter
...
- cross-model-video-prompt-adapter remains independent because its outcome and required inputs differ.
