---
name: data-driven-ad-creative-video
description: Use for controlled ad-video variants from approved tabular data from approved user facts and assets; unlike $generate-video (relationship 0.67), choose this when the stated specialized output and preservation contract are required; choose $generate-video for its generic final-media contract.
---
# Data-driven Ad Creative Video
...
- Produces one structured brief for: controlled ad-video variants from approved tabular data.
...
```text
Create a controlled ad-video variants from approved tabular data from my approved source material. Preserve the named facts and clearly identify every assumption.
```
