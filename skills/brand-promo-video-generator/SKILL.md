...
- Cover image: https://ai-image.weshop.com/desktop/coverImage/brand-promo-video-generator.png
- Cover motion: https://ai-image.weshop.com/desktop/coverVideo/brand-promo-video-generator.mp4
...
Provide the campaign subject and goal, target audience/channel, duration, ratio, official URL when relevant, supplied logo/UI/product/people/packaging assets, brand colors/type guidance, verified features or claims, required copy/CTA/disclaimers, language, audio preference, and forbidden content.
...
3. Create a compact provenance manifest for every identity-bearing asset: stable ID, role, user path or exact source, source type, verification target, authenticity status, and publication caveat. Never redraw or approximate logos, wordmarks, product UI, packaging, mascots, named people, or other identity evidence. Ask for a supplied original when a required identity asset is unavailable.
4. Choose one campaign spine appropriate to the subject: intent-to-result for apps/SaaS, context-to-proof for services, collection-to-experience for shops, identity-to-benefit for brands, or reveal-to-action for launches. Define hook, mechanism or experience, verified proof, payoff, brand lockup, and CTA. Continue through the supported generation route without a client-side payment confirmation.
...
6. Generate only missing non-identity visuals and atomic shots. Select one current model per shot: Kling 3.0 for precise product/UI or one/two-frame control; Kling V3 Omni for several named brand/product/cast/scene references or a motion-reference video; Seedance 2.5 for long multimodal/audio-visual/artistic/talking performance; Veo 3.1 for one-source-image premium synchronous dialogue/SFX at 16:9 or 9:16; Seedance 2.0 for routine image-led motion; MiniMax H3 for justified large-amplitude or natural human action. Use one durable `operationKey`, require `executionId`, poll to terminal state, and never trial models in sequence.
...
- Model policy: Kling 3 precise product/UI frames; Kling Omni complex/motion references; Seedance 2.5 long audiovisual/artistic/performance; Veo source-image synchronous audio; Seedance 2.0 routine; H3 large/natural motion
- Downstream use: Human brand, claim, channel, and publication review
