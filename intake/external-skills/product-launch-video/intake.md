# External Skill intake: product-launch-video
...
- User-visible outcomes: product launch-film plan with reveal arc.
...
- Proposed standalone Atom: product-launch-video
...
- Proposed frontmatter distinction: Use for product launch-film plan with reveal arc; unlike $make-video-intro (relationship 0.67), select it for its declared output contract.
...
| --- | --- | --- |
| Create a product launch-film plan with reveal arc | product-launch-video | Candidate output is explicit |
| Plan a product launch-film plan with reveal arc with preserved facts | product-launch-video | Candidate contract applies |
| Revise this product launch-film plan with reveal arc without changing approved assets | product-launch-video | Candidate preservation applies |
