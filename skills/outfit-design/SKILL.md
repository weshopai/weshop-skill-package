...
Apply the package `model-selection-policy.md`. Never run several models merely to compare quality. Choose from the input contract and retry only the failed property.
