...
5. Obtain approval for the story/visual/shot package before paid generation unless the user has already authorized that exact package. Select one current cataloged model per shot: Kling 3.0 for precise frames or complex references, Seedance 2.5 for audio-visual/artistic synchronization, Seedance 2.0 for routine motion, and MiniMax H3 for justified large-amplitude action. Never trial models in sequence.
...
- Model policy: One current cataloged model per atomic shot; Kling 3.0 for precise references, Seedance 2.5 for audiovisual/artistic work, Seedance 2.0 routine, MiniMax H3 justified large motion
