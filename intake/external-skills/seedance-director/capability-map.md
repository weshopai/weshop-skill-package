# WeShop capability substitution: seedance-director
...
- Provider-specific Seedance syntax, forced question UI/subagents, full-frame default spend, and duplicate orchestration.

## Proposed Atom boundaries

- Merge visible-asset, missing-asset, and prompt-handoff checks into `plan-film-storyboard` and existing video Atoms.
