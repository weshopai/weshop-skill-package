# External Skill intake: cinematic-video-prompt
...
- User-visible outcomes: cinematic or image-to-video motion prompt.
...
- Proposed standalone Atom: cinematic-video-prompt
...
- Proposed frontmatter distinction: Use for cinematic or image-to-video motion prompt; unlike $generate-video (relationship 0.67), select it for its declared output contract.
...
| --- | --- | --- |
| Create a cinematic or image-to-video motion prompt | cinematic-video-prompt | Candidate output is explicit |
| Plan a cinematic or image-to-video motion prompt with preserved facts | cinematic-video-prompt | Candidate contract applies |
| Revise this cinematic or image-to-video motion prompt without changing approved assets | cinematic-video-prompt | Candidate preservation applies |
