...
- Best fit: demanding commercial lighting/material rendering, Asian fashion/e-commerce aesthetics, high-resolution reference work, and sketch/wireframe-to-polished rendering when text is not critical.
- Use concise, concrete language: subject and action, composition, lighting/material, palette, mood, then preservation and medium lock.
- For references, name each image's role and distinguish geometry/layout anchors from palette, lighting, material, or style inspiration.
