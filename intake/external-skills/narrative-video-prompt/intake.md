# External Skill intake: narrative-video-prompt
...
- User-visible outcomes: structured one-shot narrative video prompt.
...
- Proposed standalone Atom: narrative-video-prompt
...
- Proposed frontmatter distinction: Use for structured one-shot narrative video prompt; unlike $generate-video (relationship 0.67), select it for its declared output contract.
...
| --- | --- | --- |
| Create a structured one-shot narrative video prompt | narrative-video-prompt | Candidate output is explicit |
| Plan a structured one-shot narrative video prompt with preserved facts | narrative-video-prompt | Candidate contract applies |
| Revise this structured one-shot narrative video prompt without changing approved assets | narrative-video-prompt | Candidate preservation applies |
