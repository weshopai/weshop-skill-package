# External Skill intake: short-audiovisual-prompt
...
- User-visible outcomes: compact single-shot audiovisual prompt.
...
- Proposed standalone Atom: short-audiovisual-prompt
...
- Proposed frontmatter distinction: Use for compact single-shot audiovisual prompt; unlike $generate-video (relationship 0.67), select it for its declared output contract.
...
| --- | --- | --- |
| Create a compact single-shot audiovisual prompt | short-audiovisual-prompt | Candidate output is explicit |
| Plan a compact single-shot audiovisual prompt with preserved facts | short-audiovisual-prompt | Candidate contract applies |
| Revise this compact single-shot audiovisual prompt without changing approved assets | short-audiovisual-prompt | Candidate preservation applies |
