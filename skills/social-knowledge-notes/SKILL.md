---
name: social-knowledge-notes
description: Use for fact-checked multi-page social knowledge-note plan from approved user facts and assets; unlike $make-infographic (relationship 0.67), choose this when the stated specialized output and preservation contract are required; choose $make-infographic for its generic final-media contract.
---
# Social Knowledge Notes
...
- Produces one structured brief for: fact-checked multi-page social knowledge-note plan.
...
```text
Create a fact-checked multi-page social knowledge-note plan from my approved source material. Preserve the named facts and clearly identify every assumption.
```
