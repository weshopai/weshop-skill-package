# External Skill intake: video-prompt-failure-diagnosis
...
- User-visible outcomes: diagnosis and revision of a known defective video result.
...
- Proposed standalone Atom: video-prompt-failure-diagnosis
...
- Proposed frontmatter distinction: Use for diagnosis and revision of a known defective video result; unlike $generate-video (relationship 0.67), select it for its declared output contract.
...
| --- | --- | --- |
| Create a diagnosis and revision of a known defective video result | video-prompt-failure-diagnosis | Candidate output is explicit |
| Plan a diagnosis and revision of a known defective video result with preserved facts | video-prompt-failure-diagnosis | Candidate contract applies |
| Revise this diagnosis and revision of a known defective video result without changing approved assets | video-prompt-failure-diagnosis | Candidate preservation applies |
