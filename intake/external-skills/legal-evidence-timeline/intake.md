# External Skill intake: legal-evidence-timeline
...
- Source: https://github.com/MiaoQichuan/new-litigation-visualization
- Source revision: 0b2c8f81f272e52e89b8e2c60d83ac1a3b1685e0
...
- User-visible outcomes: traceable chronology from user-supplied legal evidence.
...
- Proposed standalone Atom: legal-evidence-timeline
...
- Proposed frontmatter distinction: Use for traceable chronology from user-supplied legal evidence; unlike $make-infographic (relationship 0.67), select it for its declared output contract.
...
| --- | --- | --- |
| Create a traceable chronology from user-supplied legal evidence | legal-evidence-timeline | Candidate output is explicit |
| Plan a traceable chronology from user-supplied legal evidence with preserved facts | legal-evidence-timeline | Candidate contract applies |
| Revise this traceable chronology from user-supplied legal evidence without changing approved assets | legal-evidence-timeline | Candidate preservation applies |
