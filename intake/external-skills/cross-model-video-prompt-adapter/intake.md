# External Skill intake: cross-model-video-prompt-adapter
...
- User-visible outcomes: semantic adaptation of an existing video prompt.
...
- Proposed standalone Atom: cross-model-video-prompt-adapter
...
- Proposed frontmatter distinction: Use for semantic adaptation of an existing video prompt; unlike $generate-video (relationship 0.67), select it for its declared output contract.
...
| --- | --- | --- |
| Create a semantic adaptation of an existing video prompt | cross-model-video-prompt-adapter | Candidate output is explicit |
| Plan a semantic adaptation of an existing video prompt with preserved facts | cross-model-video-prompt-adapter | Candidate contract applies |
| Revise this semantic adaptation of an existing video prompt without changing approved assets | cross-model-video-prompt-adapter | Candidate preservation applies |
