# WeShop capability substitution: music-video-workflow

| External behavior | Inputs and constraints | WeShop decision | Evidence |
| --- | --- | --- | --- |
| Music-led video planning and production; current music-video Atom remains the delivery owner. | Authorized assets/facts, explicit preservation constraints, and observable acceptance | Compose/differentiate; use only a current verified route if promoted | Source entrypoint review and current Router contract |
...
- Adjacent current ownership: `make-music-video`.
