---
name: video-prompt-failure-diagnosis
description: Use for diagnosis and revised prompt after a known defective result from approved user facts and assets; unlike $generate-video (relationship 0.67), choose this when the stated specialized output and preservation contract are required; choose $generate-video for its generic final-media contract.
---
# Video Prompt Failure Diagnosis
...
- Tone: blue
- Short description: Diagnosis and revised prompt after a known defective result.

## What this skill does

- Freezes the request, approved facts, source assets, constraints, and acceptance checks.
- Produces one structured brief for: diagnosis and revised prompt after a known defective result.
...
```text
Create a diagnosis and revised prompt after a known defective result from my approved source material. Preserve the named facts and clearly identify every assumption.
```
